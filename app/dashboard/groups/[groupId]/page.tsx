                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-3 py-2 pr-10 text-gray-900"
                                    />
                                    <button
                                        type="button"
